...
template <int type> inline double j0(double c_e, double c_a) {
  const double k = (type == 1 ? constant::k_an : constant::k_ca);
  return k * std::sqrt(c_e * (1 - c_a) * c_a);
}

template <int type> inline double d_j0_e(double c_e, double c_a) {
  const double k = (type == 1 ? constant::k_an : constant::k_ca);
  return k * std::sqrt(c_a * (1 - c_a)) / std::sqrt(c_e) * 0.5;
}

template <int type> inline double d_j0_a(double c_e, double c_a) {
  const double k = (type == 1 ? constant::k_an : constant::k_ca);
...
template <int type> inline double uoc(double c) {
  if (type == 1)
...
template <int type> inline double d_uoc(double c) {
  if (type == 1) {
